                            ...
                            >
                                ...
                                <div className="block_wraper">
                                    ...
                                    <div className="block">
                                        ...
                                        <div className="icon"  style = {{ background: `url(/images/images/team_icons/${data.localThmb}.png)` }}></div>
                                    ...
                                    <div className="block">
                                        ...
                                        <div className="icon"  style = {{ background: `url(/images/images/team_icons/${data.awayThmb}.png)` }}></div>
